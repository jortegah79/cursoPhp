...
<h1>LA BLOGUERIA</h1>
    ...
    <div class="text-center">
        <h1 class="mt-5">LOGIN USUARIOS</h1>
        <H3>Introduce tus usuario y contraseña</H3>
        <div>
        <div class="row">
            <div class="col-12 offset-md-3 col-md-6 p-4 ">
               <form action="../controller/login_controller.php" method="post">
                <table >
                    <tr >
                        <td class="text-center lead">Usuario:</td>
                        <td ><input id="usuario" name="usuario" type="text" /></td>
                    </tr>
                    <tr>
                        <td class=" text-center lead">Password:</td>
                        <td ><input id="password" name="password" type="password" /></td>
                    </tr>

                    <tr><td><a class="nuevo" href="../controller/registro_usuario_controller.php">Nuevo registro</a></td>
